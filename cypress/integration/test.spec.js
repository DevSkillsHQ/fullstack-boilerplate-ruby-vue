...
describe('Account Management Backend - Level 2', () => {
...
describe('Account Management Frontend - Level 2', () => {
  it('should load and submit transactions', () => {
    ...
    cy.get('[data-type=transaction]')
      .first()
      .get('[data-account-id=70ad2f95-aa52-4e04-a085-c5cc2a4d4ee4][data-amount=30][data-balance=30]')
      .should('exist')
    ...
    cy.get('[data-type=transaction]')
      .first()
      .get('[data-account-id=aaad2f95-aa52-4e04-a085-c5cc2a4d4ee4][data-amount=7][data-balance=7]')
      .should('exist')
    ...
    cy.get('[data-type=transaction]')
      .first()
      .get('[data-account-id=aaad2f95-aa52-4e04-a085-c5cc2a4d4ee4][data-amount=-7][data-balance=0]')
      .should('exist')
  })
  ...
  it('should reject invalid input data', () => {
    ...
    cy.get('[data-type=transaction]')
      .first()
      .get('[data-account-id=6113255d-318f-4128-9e2a-a1c1b796a29e][data-amount=9][data-balance=9]')
      .should('exist')
